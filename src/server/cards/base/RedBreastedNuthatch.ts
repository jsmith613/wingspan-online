...
export class RedBreastedNuthatch extends BirdCard {
  readonly name = BirdCardName.RED_BREASTED_NUTHATCH;
  readonly commonName = 'Red-Breasted Nuthatch';
  readonly scientificName = 'Sitta canadensis';
