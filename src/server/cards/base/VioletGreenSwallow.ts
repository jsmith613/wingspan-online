...
export class VioletGreenSwallow extends BirdCard {
  readonly name = BirdCardName.VIOLET_GREEN_SWALLOW;
  readonly commonName = 'Violet-Green Swallow';
  readonly scientificName = 'Tachycineta thalassina';
