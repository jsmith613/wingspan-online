...
export class YellowRumpedWarbler extends BirdCard {
  readonly name = BirdCardName.YELLOW_RUMPED_WARBLER;
  readonly commonName = 'Yellow-Rumped Warbler';
  readonly scientificName = 'Setophaga coronata';
