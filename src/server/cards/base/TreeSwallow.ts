...
export class TreeSwallow extends BirdCard {
  readonly name = BirdCardName.TREE_SWALLOW;
  readonly commonName = 'Tree Swallow';
  readonly scientificName = 'Tachycineta bicolor';
