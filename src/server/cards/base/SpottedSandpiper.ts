...
export class SpottedSandpiper extends BirdCard {
  readonly name = BirdCardName.SPOTTED_SANDPIPER;
  readonly commonName = 'Spotted Sandpiper';
  readonly scientificName = 'Actitis macularius';
