...
export class ClarksNutcracker extends BirdCard {
  readonly name = BirdCardName.CLARKS_NUTCRACKER;
  readonly commonName = 'Clark\'s Nutcracker';
  readonly scientificName = 'Nucifraga columbiana';
