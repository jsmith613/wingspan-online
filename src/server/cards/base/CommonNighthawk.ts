...
export class CommonNighthawk extends BirdCard {
  readonly name = BirdCardName.COMMON_NIGHTHAWK;
  readonly commonName = 'Common Nighthawk';
  readonly scientificName = 'Chordeiles minor';
