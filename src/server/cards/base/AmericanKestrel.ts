...
export class AmericanKestrel extends BirdCard {
  readonly name = BirdCardName.AMERICAN_KESTREL;
  readonly commonName = 'American Kestrel';
  readonly scientificName = 'Falco sparverius';
