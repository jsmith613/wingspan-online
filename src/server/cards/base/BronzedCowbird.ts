...
export class BronzedCowbird extends BirdCard {
  readonly name = BirdCardName.BRONZED_COWBIRD;
  readonly commonName = 'Bronzed Cowbird';
  readonly scientificName = 'Molothrus aeneus';
