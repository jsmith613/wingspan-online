...
export class NorthernHarrier extends BirdCard {
  readonly name = BirdCardName.NORTHERN_HARRIER;
  readonly commonName = 'Northern Harrier';
  readonly scientificName = 'Circus hudsonius';
