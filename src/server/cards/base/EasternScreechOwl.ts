...
export class EasternScreechOwl extends BirdCard {
  readonly name = BirdCardName.EASTERN_SCREECH_OWL;
  readonly commonName = 'Eastern Screech-Owl';
  readonly scientificName = 'Megascops asio';
