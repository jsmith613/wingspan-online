...
export class JuniperTitmouse extends BirdCard {
  readonly name = BirdCardName.JUNIPER_TITMOUSE;
  readonly commonName = 'Juniper Titmouse';
  readonly scientificName = 'Baeolophus ridgwayi';
